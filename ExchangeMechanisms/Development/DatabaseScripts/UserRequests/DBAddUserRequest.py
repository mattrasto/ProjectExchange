...
# Version:     3.0
# Purpose:     Adds User Request to specified order under specified user
#
# Author:      Matthew
#
# Created:     06/02/2014
...
def main(Username, ContractNumber):
    ...
    #Exits if specified contract does not have a username
    if MTCUsername == None and LoanUsername == None and PrivateTradeUsername == None:
        print ""
        print "CRITICAL ERROR: Specified contract does not have a username"
        sys.exit()
