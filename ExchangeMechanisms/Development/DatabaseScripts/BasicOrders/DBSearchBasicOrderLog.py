#-------------------------------------------------------------------------------
# Name:        DBSearchBasicOrderLog
# Version:     3.0
# Purpose:     Searches BasicOrderLog with specified constraints
#
# Author:      Matthew
#
# Created:     10/31/2014
...
def main(SearchParameter, SearchValue):
    ...
    if SearchParameter == "ORDER NUMBER":
        ...
        #Search query
        try:
            OrderNumberSearch = """SELECT * FROM BasicOrderLog WHERE OrderNumber = %d""" % (SearchValue)
    ...
    if SearchParameter == "USERNAME":
        ...
        #Search query
        try:
            UsernameSearch = """SELECT * FROM BasicOrderLog WHERE Username = "%s" """ % (SearchValue)
    ...
    if SearchParameter == "PRICE":
        ...
        #Search query
        try:
            PriceSearch = "SELECT * FROM BasicOrderLog WHERE Price = %f" % (SearchValue)
    ...
    if SearchParameter == "VOLUME":
        ...
        #Search query
        try:
            VolumeSearch = "SELECT * FROM BasicOrderLog WHERE Volume = %f" % (SearchValue)
    ...
    if SearchParameter == "TYPE":
        ...
        #Search query
        try:
            TypeSearch = """SELECT * FROM BasicOrderLog WHERE Type = "%s" """ % (SearchValue)
    ...
    if SearchParameter == "ACTION":
        ...
        #Search query
        try:
            ActionSearch = """SELECT * FROM BasicOrderLog WHERE Action = "%s" """ % (SearchValue)
    ...
    if SearchParameter == "TRIGGER TYPE":
        ...
        #Search query
        try:
            TriggerTypeSearch = """SELECT * FROM BasicOrderLog WHERE TriggerType = "%s" """ % (SearchValue)
    ...
    if SearchParameter == "TRIGGER VALUE":
        ...
        #Search query
        try:
            TriggerValueSearch = """SELECT * FROM BasicOrderLog WHERE TriggerValue = %f """ % (SearchValue)
    ...
    print Orders
    if SearchParameter == "ORDER NUMBER" and Orders != ():
        return Orders[0]
    else:
        return Orders
...
if __name__ == "__main__":
    ...
    ParameterCheck = "SHOW COLUMNS FROM BasicOrderLog"
